...
from src.auto_dropout.model.decoder import Decoder
from src.auto_dropout.model.encoder import Encoder
from src.auto_dropout.model.feature import FeatureLayer
...
class VAE(nn.Module):
    def __init__(self, feature_processors: List[nn.Module],
        ...
        self.dropouts = [nn.Dropout(p=0.5) for _ in range(self.n_features)]
